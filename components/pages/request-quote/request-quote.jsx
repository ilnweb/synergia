        ...
        <div className='row'>
          <div className='col-xl-8 xl-mb-30'>
            <div className='request__quote-page-left'>
              ...
              <p>
                This is a good first step. We promise we will get back to you within one business
                day.
              </p>
                ...
                <div className='row'>
                  <div className='col-md-6 mb-30'>
                    <div className='request__quote-page-item'>
                      <input
                        ...
                        required='required'
                      />
                      <label className='request__quote-page-item-label'>
                        Full Name<span> *</span>
                      </label>
                    </div>
                  </div>
                  ...
                  <div className='col-md-12 mb-30'>
                    <div className='request__quote-page-item'>
                      <textarea
                        name='message'
                        placeholder='Describe your idea or project briefly'
                      ></textarea>
                      <label className='request__quote-page-item-label'>
                        Message ( describe your requirements.... )<span> *</span>
                      </label>
                    </div>
                  </div>
                  <div className='col-md-12 mb-30'>
                  ...
                  <div className='col-lg-12'>
                    ...
                    <label className='space'>
                      <input type='checkbox' />
                      <span>
                        Join our mailing list to get our blog updates. You can unsubscribe at any
                        time. We respect your privacy and will never share your information.
                      </span>
                    </label>
              ...
              <Swiper modules={[EffectFade, Autoplay, Pagination]} {...slideControl}>
                <SwiperSlide>
                  <div className='request__quote-page-right-item'>
                    ...
                    <p>
                      A good design review should be well-organized and structured, with a clear
                      introduction that explains the purpose of the review and sets the context for
                      the evaluation. The reviewer should provide a detailed analysis of the
                      product's design, including its layout, color scheme..
                    </p>
                ...
                <SwiperSlide>
                  <div className='request__quote-page-right-item'>
                    ...
                    <p>
                      In addition to analyzing the visual aspects of the design, a high-quality
                      review should also evaluate the product's functionality, assessing how well it
                      performs its intended tasks and how user-friendly it is. The reviewer should
                      consider factors such as ease of use, intuitive navigation..
                    </p>
                    <div className='request__quote-page-right-item-bottom'>
                ...
                <SwiperSlide>
                  <div className='request__quote-page-right-item'>
                    ...
                    <p>
                      A good review should be structured in a clear and organized way, with an
                      introduction that sets the context and explains the purpose of the review, a
                      detailed analysis of the product's features and performance, and a conclusion
                      that summarizes the key findings and provides..
                    </p>
                    <div className='request__quote-page-right-item-bottom'>
