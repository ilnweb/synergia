          ...
          <div className='col-lg-4 col-md-6 lg-mb-25'>
            <div className='pricing__area-item'>
              <div className='pricing__area-item-price'>
                <h6>Basic Plan</h6>
                <h2>
                  <span>$</span> 129<span> / Month</span>
                </h2>
              </div>
              <div className='pricing__area-item-list'>
                <ul>
                  <li>
                    <i className='flaticon-check'></i>Installation
                  </li>
                  <li>
                    <i className='flaticon-check'></i>Repair & Replacement
                  </li>
                  <li>
                    <i className='flaticon-check'></i>Monitoring Work
                  </li>
                  <li>
                    <i className='flaticon-close'></i>Panel Maintenance
                  </li>
                  <li>
                    <i className='flaticon-close'></i>24/7 Skilled Support
                  </li>
                </ul>
              </div>
            ...
            <div className='pricing__area-item'>
              ...
              <div className='pricing__area-item-list'>
                <ul>
                  ...
                  <li>
                    <i className='flaticon-close'></i>Monitoring Work
                  </li>
                  <li>
                    <i className='flaticon-check'></i>Panel Maintenance
                  </li>
                  <li>
