            ...
            <div className='col-xl-12'>
              <div className='choose__us-area'>
                <div className='choose__us-area-title'>
                  ...
                  <p>
                    Trust is not just a word for us; it's a commitment woven into the Fabric of our
                    interactions. Clients place their confidence in us Because we consistently
                  </p>
                </div>
                ...
                <div className='choose__us-area-bottom'>
                  ...
                  <div className='choose__us-area-bottom-tel sm-mt-25'>
                    <h6>
                      ...
                      <br />
                      Feel free to contact <Link href='tel:+123(548)5256'> +123 (548) 5256</Link>
                    </h6>
                  </div>
                </div>
