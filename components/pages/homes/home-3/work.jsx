            ...
            <div className='col-lg-6 lg-mb-25'>
              <div className='work__area-left'>
                <div className='work__area-left-title'>
                  ...
                  <p>
                    The phrase captures the essence of harnessing solar power not only as a source
                    of clean energy but also as a driving force behind advancements
                  </p>
                </div>
                <div className='work__area-left-list'>
                  ...
                  <span>
                    <i className='fa-sharp fa-solid fa-circle-check'></i>We're very professional
                  </span>
                </div>
                <a className='btn-three' href='about.html'>
                  Explore now
                </a>
              </div>
            </div>
