            ...
            <div className='col-lg-6 lg-mb-25'>
              <div className='consultation__area-left t-right dark_image'>
                ...
                <div className='content'>
                  ...
                  <p>
                    <span>25,000</span> Customer Satisfaction services
                  </p>
                </div>
              </div>
            </div>
            <div className='col-lg-6'>
              <div className='consultation__area-right'>
                <div className='consultation__area-right-title'>
                  ...
                  <p>
                    Solar Powering Your Sustainable Scene is a vibrant and compelling phrase that
                    conveys the idea of integrating solar energy,
                  </p>
                </div>
                <div className='consultation__area-right-list'>
                  <div className='row'>
                    <div className='col-sm-6'>
                      <div
                        className='consultation__area-right-list-item sm-mb-25'
                        data-background='assets/img/shape/shape-19.png'
                      >
                    ...
                    <div className='col-sm-6'>
                      <div
                        className='consultation__area-right-list-item'
                        data-background='assets/img/shape/shape-19.png'
                      >
                        <div className='consultation__area-right-list-item-icon'>
