        ...
        >
          <SwiperSlide>
            <div className='banner__three-area'>
              <div
                className='banner__three-area-image'
                ...
                <div className='row align-items-center'>
                  <div className='col-xl-12'>
                    <div className='banner__three-content'>
                      ...
                      <h2>Sustainable</h2>
                      <h1>Sunlight</h1>
                      <Link className='btn-three' href='/about'>
                        Discover More
                      </Link>
                    </div>
                  </div>
            ...
            <div className='col-lg-12'>
              <div className='banner__three-slide-area'>
                ...
                <div className='banner__three-slide-area-arrow'>
                  <div className='banner__three-slide-area-arrow-prev banner_prev'>
                    <i className='fal fa-long-arrow-left'></i>
                  </div>
                  <div className='banner__three-slide-area-arrow-next banner_next'>
