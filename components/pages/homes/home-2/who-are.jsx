...
const WhoAre = ({ addClass }) => {
  return (
    <>
      <div
        className={`who__area ${addClass} section-padding`}
        style={{ backgroundImage: `url(${bannerBg1.src})` }}
      >
                ...
                <div className='tab-content'>
                  <div className='tab-pane fade' id='technology'>
                    <div className='who__area-right-tab'>
                      <p>
                        The phrase captures the essence of harnessing solar power not only as a
                        source of clean energy but also as a driving force behind advancements and
                        accomplishments. Picture a scene where the rays of the sun are not merely
                        beams of light but
                      </p>
                      <div className='who__area-right-tab-list'>
                        ...
                        <span>
                          <i className='fa-sharp fa-solid fa-circle-check'></i>Business Accounting
                        </span>
                        <span>
                          <i className='fa-sharp fa-solid fa-circle-check'></i>Award Winning Company
                        </span>
                        <span>
                          <i className='fa-sharp fa-solid fa-circle-check'></i>We're very
                          professional
                        </span>
                      </div>
                    </div>
