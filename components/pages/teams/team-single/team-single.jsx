                ...
                <div className='team__details-left-info-contact'>
                  <div className='team__details-left-info-contact-item'>
                    ...
                    <div className='team__details-left-info-contact-item-info'>
                      ...
                      <h6>
                        <Link href={`mailto:${teamDetails?.mail}`}>{teamDetails?.mail}</Link>
                      </h6>
                    </div>
                  </div>
                  <div className='team__details-left-info-contact-item'>
                    ...
                    <div className='team__details-left-info-contact-item-info'>
                      ...
                      <h6>
                        <Link href={`tel:${teamDetails?.phone}`}>{teamDetails?.phone}</Link>
                      </h6>
                    </div>
                  </div>
                  <div className='team__details-left-info-contact-item'>
          ...
          <div className='col-xl-7 col-lg-7'>
            <div className='team__details-right ml-20 xl-ml-0'>
              <div className='team__details-right-experience'>
                ...
                <p>
                  This involves assessing one's skills, interests, values, and personality traits to
                  identify suitable career paths. Self-assessment can be done through career tests,
                  online resources, or working with a career counselor.
                </p>
                <p>
                  Employers look for candidates with specific skills and abilities. Individuals
                  should focus on developing the skills and competencies needed for their desired
                  career through education, training, and work experience.
                </p>
                <p>
                  Different careers require different levels of education and training. Individuals
                  should research the educational requirements for their desired career and develop
                  a plan to acquire the necessary education and credentials. Continuing education
              ...
              <div className='team__details-right-skill'>
                ...
                <p>
                  These are the skills required to operate specific tools, software, or equipment in
                  a particular field. For example, a web developer needs to have technical skills in
