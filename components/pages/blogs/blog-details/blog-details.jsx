          ...
          <div className='row'>
            <div className='col-xl-8 col-lg-8 lg-mb-50'>
              <div className='blog__details-left dark_image'>
                ...
                <p>
                  Discover the latest innovations in solar technology that are driving a wave of
                  positive change across the globe. From photovoltaic advancements to smart grid
                  integration, we delve into the cutting-edge solutions that make solar energy an
                  increasingly viable and accessible option. Learn how solar power not only reduces
                  our dependence on traditional energy sources but also,
                </p>
                <p>
                  Our blog goes beyond the technical aspects, offering insights into the economic
                  and societal impact of widespread solar adoption. Explore success stories, case
                  studies, and real-world applications that showcase how solar energy is not just an
                  eco-friendly choice but a practical and economically sound investment.
                </p>
                <div className='blog__details-left-box'>
                  <i className='fa-sharp fa-solid fa-ditto'></i>
                  <div>
                    <h5>
                      Design is a comprehensive approach to creating digital products that are both
                      visually
                    </h5>
                ...
                <p>
                  Embark on a journey through the sunrise of possibilities as we delve into
                  sustainable practices, energy-efficient technologies, and the myriad choices
                  available to individuals and businesses seeking a greener path. From residential
                  solar installations to large-scale solar farms, our blog sheds light on the
                  diverse ways solar energy is making its mark on the world.
                </p>
                <div className='row mt-35 mb-30'>
                  <div className='col-12'>
                    <img className='img__full' src={image1.src} alt='blog-image' />
                  </div>
                </div>
                <p>
                  Discover the voices advocating for solar solutions – from industry experts and
                  environmental enthusiasts to the communities benefitting from solar initiatives.
                  We share stories that inspire change, emphasizing the importance of collective
                  voices in shaping a sustainable future.
                </p>
                <p>
                  Join us on a journey through the sunrise of possibilities as we explore the
                  various choices available in the realm of solar energy. From residential solar
                  solutions to innovative technologies,
                </p>
                ...
                <div className='blog__details-left-author'>
                  ...
                  <div className='blog__details-left-author-content'>
                    <h6>Joshua Harvey</h6>
                    <p>
                      Starting a product design from scratch is an iterative process that may
                      involve multiple cycles of design,
                    </p>
                  ...
                  <div className='blog__details-left-comment-item'>
                    <div className='blog__details-left-comment-item-comment'>
                      ...
                      <div className='blog__details-left-comment-item-comment-content'>
                        ...
                        <span>20 April, 2024 At 9:PM</span>
                        <p>
                          Pellentesque a placerat orci. Suspendisse rutrum lacus ipsum, eu vulputate
                          augue blandit mollis.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className='blog__details-left-comment-item ml-65 sm-ml-0'>
                    <div className='blog__details-left-comment-item-comment'>
                      ...
                      <div className='blog__details-left-comment-item-comment-content'>
                        ...
                        <span>22 April, 2024 At 7:PM</span>
                        <p>
                          Pellentesque a placerat orci. Suspendisse rutrum lacus ipsum, eu vulputate
                          augue blandit mollis.
                        </p>
