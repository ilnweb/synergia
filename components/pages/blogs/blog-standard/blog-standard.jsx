              ...
              {currentBlogItems?.map((data, id) => (
                <div className='blog__standard-item' key={id}>
                  ...
                  <div className='blog__standard-item-content'>
                    ...
                    <p>
                      Utilizing solar panels to capture photovoltaic energy converts sunlight
                      directly into electricity without releasing pollutants into the atmosphere.
                    </p>
                    <Link className='btn-one' href={`/blog/${data.id}`}>
                      Read Details
                    </Link>
                  </div>
                </div>
